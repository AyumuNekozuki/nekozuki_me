  ...
  <div class="about">
    <div class="wrapper">
      <div class="text_area">
        ...
        <h3>当サイトの構成</h3>
        <p>詳細は <a href="/makes/nekozuki_portal">こちら</a> のページを御覧ください。</p>

        <h3>データ収集/広告について</h3>
        <p>当サイトでは、 Google LLC 提供の Googleアナリティクスを利用しています。</p>
        <p>これらのサービスでは、トラフィックデータの収集のためにCookieを利用しています。このトラフィックデータは匿名で収集されており、個人を特定するものではありません。収集されないようにしたい場合は、ブラウザの設定からCookieを無効化していただくようお願い致します。</p>
        ...
        <h4>損害等の責任について</h4>
        <p>当サイトに掲載された内容によって生じた損害等の一切の責任を負いかねますので、ご了承ください。 また当サイトからリンクやバナーなどによって他のサイトに移動された場合、移動先サイトで提供される情報、サービス等について一切の責任も負いません。</p>
        ...
        <h4>画像の著作権や肖像権等について</h4>
        <p>当サイトで掲載している画像の著作権や肖像権等は、各権利所有者に帰属します。万が一問題がある場合は、以下お問い合わせよりご連絡いただけますよう宜しくお願い致します。</p>
        <h4>問い合わせ先</h4>
        <p>猫月遥歩（ねこづきあゆむ）</p>
